...
//       if (isFiltered && productId) {
//         dispatch(getReviews(productId));
//       } else {
//         dispatch(getAllReviews());
//       }
//     }
//   }, [dispatch, error, isReviewDeleted, isFiltered, productId]);
...
//           <form onSubmit={submitHandler} className="flex gap-2 mt-2 md:mt-0">
//             <input
//               type="text"
...
//                   <tr>
//                     <th className="px-4 py-2 text-start text-xs font-medium text-white uppercase hidden md:table-cell">
//                       ID
//                     </th>
...
//                     <tr key={review._id}>
//                       <td className="px-4 py-2 text-start text-gray-800 hidden md:table-cell">
//                         {review._id}
//                       </td>
//                       <td className="px-4 py-2 text-start text-gray-800">
//                         {product?.name || review.product?.name || "N/A"}
//                       </td>
//                       <td className="px-4 py-2 text-start text-gray-800">
//                         {review.rating}
//                       </td>
...
//     try {
//       const productResult = await dispatch(getProduct(productId));
//       const reviewResult = await dispatch(getReviews(productId));

//       const productFound = productResult?.payload?.name;
//       const reviewsFetched = Array.isArray(reviewResult?.payload)
//         ? reviewResult.payload
//         : [];

//       if (productFound) {
//         setIsFiltered(true); // ✅ Always show "Show All" when product found
//       }

//       if (productFound && reviewsFetched.length === 0) {
//         toast.warn("No reviews found for this product", {
//           position: toast.POSITION.BOTTOM_CENTER,
//         });
//       }
//     } catch (err) {
