...
const Login = () => {
    ...
    }, [error, loading, authenticatedUser, navigate, redirect, dispatch]);
                            ...
                            <Form className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <Field
                                        ...
                                        name="email"
                                        placeholder="Enter your email"
                                        className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-[#43c2be] outline-none ${
                                ...
                                {/* Forgot Password */}
                                <div className="text-right">
                                    <Link to='/password/forgot' className="text-blue-600 hover:underline text-sm">
                                        Forgot Password?
                                    </Link>
                                </div>
